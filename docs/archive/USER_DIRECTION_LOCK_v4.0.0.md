> **ARCHIVED — superseded by [`docs/USER_DIRECTION_LOCK.md`](../USER_DIRECTION_LOCK.md) v5.0.0.**
>
> This is the lock as it stood while RunningUp was a combat RPG with a 52-checkpoint
> monthly ladder and a 96-region world. It is kept verbatim as the record of what the
> product used to be, and of what changed: the checkpoint count moved to 121, the world to
> 192 regions and 2,304 courses, and the entire combat catalogue was removed in favour of
> races, rival crews and champions (DL-6). Nothing on this page is in force. Do not
> implement from it.
