// CC0 원본 rig를 V11 전용 high-LOD 메시, palette, expression, non-combat animation prefab으로 굽는다.
#if UNITY_EDITOR
using System;
...
{
    public static class V11PremiumRunnerBaker
    {
        ...
        private static void StageSourceModel()
        {
            ...
            {
                throw new FileNotFoundException("V11 runner source model is missing.", sourcePath);
            }
        ...
        private static void BakeRunnerPrefab()
        {
            ...
            var shader = Shader.Find("RunningUp/V11 Runner Palette");
            if (atlas == null || shader == null)
            {
                throw new InvalidOperationException("V11 runner atlas or palette shader is unavailable.");
            }
            ...
            var footwearMaterial = CreatePaletteMaterial(
                ...
                "MyRunnerV11Footwear",
                1f);
            var navyMaterial = CreateSolidMaterial("MyRunnerV11Navy", V11Palette.DeepNavy);
            var mintMaterial = CreateSolidMaterial("MyRunnerV11Mint", V11Palette.Mint);
            ...
            try
            {
                ...
                if (headBone == null)
                {
                    throw new InvalidOperationException("V11 runner head bone is missing.");
                }
                ...
                Debug.Log(
                    $"RUNNINGUP_V11_RUNNER_BAKE_PASS triangles={triangleCount} " +
            ...
            Material footwearMaterial)
        {
            ...
            foreach (var renderer in renderers)
            {
                ...
                highMesh.name = $"MyRunnerV11_{Sanitize(renderer.name)}_High";
                ...
                Debug.Log(
                    $"RUNNINGUP_V11_RUNNER_MESH name={renderer.name} triangles={rendererTriangles}");
            }
            ...
            Material mintMaterial)
        {
            ...
            {
                throw new InvalidOperationException("V11 runner modular attachment bones are missing.");
            }
            ...
            float footwearMode)
        {
            ...
            material.SetColor("_Mint", V11Palette.Mint);
            material.SetColor("_Navy", V11Palette.DeepNavy);
            material.SetColor("_Coral", V11Palette.Coral);
        ...
        {
            var controllerPath = $"{AnimationRoot}/MyRunnerV11.controller";
