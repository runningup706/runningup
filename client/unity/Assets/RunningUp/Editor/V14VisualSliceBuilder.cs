...
{
    public static class V14VisualSliceBuilder
    {
        ...
        [MenuItem("RunningUp V14/Visual Slice/Build and Capture")]
        public static void BuildAndCapture()
        {
            ...
            if (font == null)
            {
                throw new InvalidOperationException("V14 font missing");
            }
            ...
            var runtime = backdropObject.AddComponent<V14VisualSliceRuntime>();
            runtime.Configure(
                hero.rectTransform,
                pacerLayer,
                far.rectTransform,
            ...
            Debug.Log($"RUNNINGUP_V14_VISUAL_SLICE_CAPTURE_PASS path={outputPath}");
        }
            ...
            Font font)
        {
            ...
            runtimeObject.AddComponent<V14RunRuntime>();
            var config = runtimeObject.AddComponent<V14SupabaseRuntimeConfig>();
            config.Configure(
                Environment.GetEnvironmentVariable("RUNNINGUP_SUPABASE_URL"),
                Environment.GetEnvironmentVariable(
                    "RUNNINGUP_SUPABASE_PUBLISHABLE_KEY"));
            runtimeObject.AddComponent<V14SupabaseSessionRuntime>();
            runtimeObject.AddComponent<V14VerifiedRunUploader>();
            var bridge = runtimeObject.AddComponent<V14AndroidRunBridge>();
