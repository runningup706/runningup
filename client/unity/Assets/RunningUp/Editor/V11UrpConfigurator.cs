...
{
    public static class V11UrpConfigurator
    {
        private const string SettingsRoot = "Assets/RunningUp/ProductionArt/Settings";
        private const string RendererPath =
            SettingsRoot + "/RunningUpV11UniversalRenderer.asset";
        private const string PipelinePath =
            SettingsRoot + "/RunningUpV11UniversalPipeline.asset";

        [MenuItem("RunningUp V11/Production Art/Configure Unity 6 URP")]
        public static void Configure()
        {
            ...
            Debug.Log(
                "RUNNINGUP_V11_URP_CONFIG_PASS editor=6000.3.20f1 " +
