// CC0 원본 모델에서 V14 러닝에 필요한 메시와 non-combat animation만 확인한다.
#if UNITY_EDITOR
using System.Linq;
using UnityEditor;
using UnityEngine;
...
{
    public static class V14VendorModelInspector
    {
        ...
        public static void Inspect()
        {
            ...
            Debug.Log(
                $"RUNNINGUP_V14_VENDOR_INSPECT_PASS meshes={meshes.Length} " +
