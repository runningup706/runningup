// V14의 다섯 하단 탭과 Daily Run Contract 표면을 실제 상호작용으로 연결한다.
...
namespace RunningUp.UI
{
    ...
    public sealed class V14HudController : MonoBehaviour
    {
        private const string GoalModeKey = "runningup.v14.goal-mode";
        ...
        private V14VerifiedRunUploader verifiedRunUploader;
        ...
        private void Awake()
        {
            ...
            if (runBridge != null)
            {
                ...
                var runtime = runBridge.GetComponent<V14RunRuntime>();
                if (runtime != null)
                {
                    runtime.StateChanged += RefreshRuntimeTexts;
                }

                verifiedRunUploader = runBridge.GetComponent<V14VerifiedRunUploader>();
        ...
        public void Configure(
            ...
            V14AndroidRunBridge androidRunBridge,
            Button strideLeap,
            Button directGps,
            Button pauseRun,
            Button finishRun,
        ...
        private void ApplyGoalModeVisuals()
        {
            for (var index = 0; index < goalModeButtons.Count; index++)
            {
                ...
                if (image != null)
                {
                    image.color = selected ? V14Palette.Mint : V14Palette.PanelNavy;
                }
        ...
        private void ApplyNavigationVisuals()
        {
            for (var index = 0; index < navigationButtons.Count; index++)
            {
                ...
                if (image != null)
                {
                    image.color = selected ? V14Palette.SkyBlue : Color.clear;
                }
