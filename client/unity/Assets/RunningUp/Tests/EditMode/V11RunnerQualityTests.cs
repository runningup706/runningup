...
namespace RunningUp.Tests.EditMode
{
    public sealed class V11RunnerQualityTests
    {
        ...
        {
            Assert.That(V11ProductionPresentationContract.Mode, Is.EqualTo("FIXED_CAMERA_2_5D"));
            Assert.That(V11ProductionPresentationContract.HeadRatioMinimum, Is.EqualTo(2.6f));
            Assert.That(V11ProductionPresentationContract.HeadRatioTarget, Is.EqualTo(2.8f));
            Assert.That(V11ProductionPresentationContract.HeadRatioMaximum, Is.EqualTo(2.9f));
            Assert.That(V11ProductionPresentationContract.ParallaxLayerMinimum, Is.EqualTo(3));
            Assert.That(V11ProductionPresentationContract.ParallaxLayerMaximum, Is.EqualTo(4));
            Assert.That(V11ProductionPresentationContract.VisiblePacerMinimum, Is.EqualTo(5));
            Assert.That(V11ProductionPresentationContract.VisiblePacerMaximum, Is.EqualTo(7));
            Assert.That(V11ProductionPresentationContract.Near3dPacerMaximum, Is.EqualTo(4));
            Assert.That(
                V11ProductionPresentationContract.Total3dSkinnedCharacterMaximum,
                Is.EqualTo(5));
        }
