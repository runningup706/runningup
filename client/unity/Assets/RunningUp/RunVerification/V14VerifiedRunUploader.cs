...
namespace RunningUp.RunVerification
{
    ...
    public static class V14SupabaseUploadContract
    {
    ...
    public sealed class V14VerifiedRunUploader : MonoBehaviour
    {
            ...
            Action<bool> completed)
        {
                ...
                UnityWebRequest.kHttpVerbPOST)
            {
                uploadHandler = new UploadHandlerRaw(
                    Encoding.UTF8.GetBytes(
                        V14SupabaseUploadContract.BuildJson(candidate))),
            ...
            var disposition = V14SupabaseUploadContract.Classify(
                request.result,
                request.responseCode);
            if (disposition == SupabaseUploadDisposition.Accepted)
            {
                if (!V14SupabaseUploadContract.TryParseResponse(
