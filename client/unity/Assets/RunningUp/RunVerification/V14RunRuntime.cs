// V14 홈에서 검증 러닝, Daily Contract, 영구 성장, 오프라인 큐 상태를 실제로 유지한다.
using System;
...
namespace RunningUp.RunVerification
{
    ...
    public sealed class V14RunRuntime : MonoBehaviour
    {
        private const string ProgressKey = "runningup.v14.runner-progress";
